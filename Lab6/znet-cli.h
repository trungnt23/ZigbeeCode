...
/** @addtogroup plugin-slot-manager Plugin Commands: Slot Manager
 * @ingroup cli
 * This plugin provides a set of CLI commands to interact with external SPI
 * flash, particularly in a setup where slots are present to work with the
 * common bootloader.
 * 
 * @{
 */

/** @brief <b>plugin slot-manager boot-slot [slotId:4] </b>
 *   - <i>Boot the image in the specified slot ID.</i>
 *     - slotId - INT32U - The slot ID to boot
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_SLOT_MANAGER_PLUGIN_SLOT_MANAGER_BOOT_SLOT

/** @brief <b>plugin slot-manager erase-slot [slotId:4] </b>
 *   - <i>Erase the specified slot ID.</i>
 *     - slotId - INT32U - The slot ID to erase
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_SLOT_MANAGER_PLUGIN_SLOT_MANAGER_ERASE_SLOT

/** @brief <b>plugin slot-manager ext-flash-info </b>
 *   - <i>Print external flash information.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_SLOT_MANAGER_PLUGIN_SLOT_MANAGER_EXT_FLASH_INFO

/** @brief <b>plugin slot-manager read [address:4] [length:1] </b>
 *   - <i>Read raw data from external flash.</i>
...
/** @brief <b>plugin slot-manager slots-info </b>
 *   - <i>Print information for all available slots.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_SLOT_MANAGER_PLUGIN_SLOT_MANAGER_SLOTS_INFO

/** @} */ // end group plugin-slot-manager
