...
bool emAfProcessEzspCommand(uint16_t commandId)
{
  switch(commandId) {
// -----------------------------------------------------------------------------
// Networking Frames
  ...
  case EZSP_GET_NEIGHBOR_FRAME_COUNTER: {
    ...
    emAfFetchOrAppend(true /* FETCH */,
                      ...
                      &eui64Length);
    // Callback.
    status = emberGetNeighborFrameCounter(eui64,
                                          &returnFrameCounter);
    // Append.
    emAfFetchOrAppend(false /* APPEND */,
                      "uw",
  ...
  case EZSP_SET_CONCENTRATOR: {
    ...
    emAfFetchOrAppend(true /* FETCH */,
                      ...
                      &maxHops);
    // Callback.
    status = emberAfEzspSetConcentratorCommandCallback(on,
                                                       concentratorType,
                                                       minTime,
                                                       maxTime,
                                                       routeErrorThreshold,
...
// Messaging Frames
  ...
  case EZSP_SEND_RAW_MESSAGE_EXTENDED: {
    ...
    emAfFetchOrAppend(true /* FETCH */,
                      ...
                      &useCca);
    // Callback.
    status = emberAfEzspSendRawMessageExtendedCommandCallback(messageLength,
                                                              messageContents,
                                                              priority,
                                                              useCca);
    // Append.
...
// Green Power Frames
  ...
  case EZSP_GP_SINK_TABLE_SET_SECURITY_FRAME_COUNTER: {
    ...
    emAfFetchOrAppend(true /* FETCH */,
                      ...
                      &sfc);
    // Callback.
    emberGpSinkTableSetSecurityFrameCounter(index,
                                            sfc);
    break;
  }
